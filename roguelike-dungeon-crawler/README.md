#Roguelike Dungeon Crawler - React project

Objective - Build a dungeon crawler game using React.js.

Requirements:  
-user has health, a level, and a weapon. A better weapon can be picked up as well as health items  
-all the items and enemies on the map are arranged at random  
-user can move throughout a map, discovering items  
-user can move anywhere within the map's boundaries, but can't move through an enemy until they've beaten it  
-much of the map is hidden. When I take a step, all spaces that are within a certain number of spaces from me are revealed  
-when the user beats the enemy, the enemy goes away and the user gets XP, which eventually increases their level  
-when the user fights an enemy, they take turns damaging each other until one of them loses. The user does damage based off of their level and weapon. The enemy does damage based off of its level. Damage is somewhat random within a range  
-when the user finds and beats the boss, the user wins  
